  ...
  return (
    <div className="navbar bg-base-100" data-theme={theme}>
      <div className="navbar-start">
        ...
        <Image src={theme === 'dark' ? ChirplingoLight : ChirplingoDark} alt="Chirplingo" height={40} />
      </div>
          ...
          <div className="btn btn-sm  btn-circle w-8 h-8 mr-2 flex items-center justify-center">
            <a className="avatar">
              <div className="rounded-full flex items-center justify-center text-lg font-bold">
                <Image src={theme === 'dark' ? AddDark : AddWhite} alt="Add" style={{height: 15, width: 15}} />
              </div>
            </a>
          </div>
        </div>

        <label onChange={toggleTheme} className="btn btn-sm  btn-circle  mr-2  items-center justify-center swap swap-rotate">
          <input type="checkbox" />
          <svg
