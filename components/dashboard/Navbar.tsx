  ...
  return (
    <div className="navbar bg-base-100" data-theme={theme}>
      <div className="navbar-start">
        ...
        <Image
          src={theme === "dark" ? ChirplingoLight : ChirplingoDark}
          alt="Chirplingo"
          height={50}
        />
      </div>
      ...
      <div className="navbar-end">
        <div className="flex">
          <div className="btn btn-sm btn-ghost btn-circle w-12 h-12 mr-3">
            <a className="avatar">
              <div className="w-10 h-10 rounded-full ring ring-offset-base-100 ring-offset-4">
                <img
          ...
          >
            <Image
              src={theme === "dark" ? AddDark : AddWhite}
              alt="Add"
